...
const WeatherInfo = props => {
    return (
           ...
           <div className="row" >
                                ...
                                <div className="row foot">
                                    <div className="col-6">
                                        <div className="reading">
                                            <svg className="wi-icon" x="0px" y="0px" viewBox="0 0 448 448" >
                                                <g>
                                                    <g>
                                                        <path d="M384,112c-35.297,0-64,28.711-64,64c0,8.836,7.156,16,16,16s16-7.164,16-16c0-17.649,14.359-32,32-32s32,14.351,32,32
                                            s-14.359,32-32,32H17.266c-8.844,0-16,7.164-16,16s7.156,16,16,16H384c35.297,0,64-28.711,64-64S419.297,112,384,112z"></path>
                                                    </g>
                                                </g>
                                                <g>
                                                    <g>
                                                        <path d="M224,48c-35.297,0-64,28.711-64,64c0,8.836,7.156,16,16,16s16-7.164,16-16c0-17.649,14.359-32,32-32s32,14.351,32,32
                                            s-14.359,32-32,32H16c-8.844,0-16,7.164-16,16s7.156,16,16,16h208c35.297,0,64-28.711,64-64C288,76.711,259.297,48,224,48z"></path>
                                                    </g>
                                                </g>
                                                <g>
                                                    <g>
                                                        <path d="M224,272H16c-8.844,0-16,7.164-16,16s7.156,16,16,16h208c17.641,0,32,14.351,32,32s-14.359,32-32,32s-32-14.351-32-32
                                            c0-8.836-7.156-16-16-16s-16,7.164-16,16c0,35.289,28.703,64,64,64c35.297,0,64-28.711,64-64C288,300.711,259.297,272,224,272z"></path>
                                                    </g>
                                                </g>
                                            </svg>
                                            <span className="wi-value"> {props.wind_speed} km/h </span>
                                        </div>
                                        <div className="reading">
                                            <svg className="wi-icon" viewBox="0 0 510.684 510.684">
                                                <g>
                                                    <g>
                                            ...
                                            <span className="wi-value"> {props.humidity} % </span>
                                        </div>
                                        <div className="reading">
                                            <svg className="wi-icon" viewBox="0 0 384 384" >
                                                <g>
                                                    <g>
			...
			c3.12,3.128,7.216,4.688,11.312,4.688s8.192-1.56,11.312-4.688C334.008,321.512,334.008,311.384,327.76,305.136z"></path>
                                                    </g>
                                                </g>
                                                <g>
                                                    <g>
			...
			c3.12,3.128,7.216,4.688,11.312,4.688s8.192-1.56,11.312-4.688l22.624-22.624C334.008,72.616,334.008,62.488,327.76,56.24z"></path>
                                                    </g>
                                                </g>
                                                <g>
                                                    <g>
			...
			c-39.696,0-72-32.304-72-72s32.304-72,72-72s72,32.304,72,72S231.696,264,192,264z"></path>
                                                    </g>
                                                </g>

                                            </svg>
                                            <span className="wi-value">  {props.country} </span>
                                        </div>
